...
def main():
    ...
    popularhashtags = ["city", "travel", "blogger", "picoftheday", "vintage", "modamasculina", "fashion", "luzern", "switzerland", "dapper", "wedding", "fashionpost", "lucerne", "fashionphotography", "gentleman", "suit", "tie", "pocketsquare", "ootd", "instagood"]
